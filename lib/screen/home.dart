...
import 'package:ahri_manager/screen/my_information.dart';
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        image: DecorationImage(
          fit: BoxFit.cover,
          image: AssetImage(
              '/Users/kimsu-in/Desktop/icecream/flutter-sw/asset/imgs/background3.jpg'),
        ),
      ),
      child: Scaffold(
        appBar: AppBar(
                      ...
                      IconButton(
                        onPressed: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => Buy_object()));
                        },
                        icon: Image.asset(
                            '/Users/kimsu-in/Desktop/icecream/flutter-sw/asset/imgs/schedule.png'),
                        iconSize: 70,
                        //padding,
                      ),
                      Text(
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => Map_hospital()));
                        },
                        icon: Image.asset(
                            '/Users/kimsu-in/Desktop/icecream/flutter-sw/asset/imgs/hospital.png'),
                        iconSize: 70,
                      ),
                      Text(
                        '병원 찾기',
                  ...
                  Column(
                    children: [
                      IconButton(
                        ...
                        icon: Image.asset(
                            '/Users/kimsu-in/Desktop/icecream/flutter-sw/asset/imgs/pet-food.png'),
                        iconSize: 70,
                      ),
                      Text(
                        "물품구매",
